...
const FullSkillOrderMappedSkills = ({ skillOrder, skillMap, loading = true }) => {
    ...
    const FullSkillOrderMappedSkillsStyles = useMemo(() => {
    ...
    const FullSkillOrderDisplayStyles = useMemo(() => {
        return styled(FlexCol)(({ leftSpace, keyHeight = 0 }) => {
            return parseStyles([
    ...
    const FullSkillOrderNumberCol = useMemo(() => {
        return styled(FlexRow)(() => {
            return parseStyles([
                tw`mb-1`,
            ]);
    ...
    const FullSkillOrderKeyCol = useMemo(() => {
        return styled(FlexRow)(({ keyHeight = 0 }) => {
            return parseStyles([
                tw`relative`,
    ...
    const FullSkillOrderDisplayNumberSmallPurpleText = useMemo(() => {
